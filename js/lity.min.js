...
!(function (a, b) {
  ...
  function c(a) {
    ...
    return (
      O && a.length
        ? (a.one(O, b.resolve), setTimeout(b.resolve, 500))
        : b.resolve(),
      b.promise()
    );
  }
  ...
  function m(a, b) {
    ...
    return (
      !!c &&
      h("https://player.vimeo.com/video/" + c[3] + "?autoplay=1", b, c[4], a)
    );
  }
  function n(a, b) {
    var c = N.exec(a);
    return (
      ...
      h(
        "https://www.facebook.com/plugins/video.php?href=" + a + "&autoplay=1",
        b,
        c[4],
        a
      ))
  ...
  function u(a) {
    1 === E.unshift(a) &&
      (D.addClass("lity-active"), B.on({ resize: t, keydown: r })),
      b("body > *")
        .not(a.element())
  ...
  function v(a) {
    var c;
    a.element().attr(F, "true"),
      1 === E.length &&
        (D.removeClass("lity-active"), B.off({ resize: t, keydown: r })),
      (E = b.grep(E, function (b) {
        return a !== b;
      })),
      (c = E.length ? E[0].element() : b(".lity-hidden")),
  ...
  function y(a, e, f, g) {
    ...
    (e = b.extend({}, I, e)),
      ...
      (l.resize = function () {
        m && !n && k.css("max-height", q() + "px").trigger("lity:resize", [l]);
      }),
      (l.close = function () {
        if (m && !n) {
          (n = !0), v(l);
          ...
          if (
            g &&
            (A.activeElement === j[0] || b.contains(j[0], A.activeElement))
          )
            try {
              g.focus();
            } catch (a) {}
  ...
  return (
    ...
    (z.version = "3.0.0-dev"),
    (z.options = b.proxy(d, z, I)),
    (z.handlers = b.proxy(d, z, I.handlers)),
    (z.current = w),
    (z.iframe = h),
    b(A).on("click.lity", "[data-lity]", z),
    z
  );
});
